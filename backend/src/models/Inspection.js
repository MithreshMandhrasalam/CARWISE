...
const inspectionSchema = new mongoose.Schema(
  {
    ...
    priceValuation: {
      version: { type: String, default: 'VALUATION_V1' },
      ...
      askingPriceAssessment: {
        ...
        varianceFromMidpoint: { type: Number, default: 0 },
    ...
    evidenceAssessment: {
      ...
      evidenceCompleteness: {
        ...
        viewQuality: [mongoose.Schema.Types.Mixed],
        blindspots: [mongoose.Schema.Types.Mixed],
      },
      evidenceReliability: {
        ...
        formulaVersion: { type: String, default: 'RELIABILITY_V1' },
      },
      trustScore: {
        trustScore: { type: Number, default: null },
        trustBand: { type: String, default: 'INSUFFICIENT_EVIDENCE' },
        status: { type: String, default: 'INSUFFICIENT_EVIDENCE' },
        formulaVersion: { type: String, default: 'TRUST_V1' },
        components: {
          evidenceCompleteness: Number,
          iqaReliability: Number,
          modelConfidence: Number,
      ...
      assessmentStatus: {
        type: String,
        enum: ['READY_FOR_ASSESSMENT', 'LIMITED_ASSESSMENT', 'INSUFFICIENT_EVIDENCE', 'PROCESSING', 'FAILED'],
    ...
    repairCostAssessment: {
      version: { type: String, default: 'REPAIR_V1' },
      currency: { type: String, default: 'INR' },
      ...
      itemizedRepairs: [
        {
          ...
          confidence: String,
          requiresPhysicalInspection: { type: Boolean, default: true },
          qualityWarning: { type: Boolean, default: false },
        },
      ],
    ...
    finalAssessment: {
      assessmentVersion: { type: String, default: 'CARWISE_ASSESSMENT_V1' },
      assessmentId: String,
      overallStatus: {
        type: String,
        enum: ['COMPLETED', 'LIMITED_ASSESSMENT', 'INSUFFICIENT_EVIDENCE', 'FAILED', 'PROCESSING'],
        default: 'PROCESSING',
      },
      componentVersions: {
        iqa: { type: String, default: 'IQA_V1' },
        cvDetector: { type: String, default: 'CV_BASELINE_V1' },
        evidenceReasoning: { type: String, default: 'EVIDENCE_V1' },
        conditionScore: { type: String, default: 'CONDITION_V1' },
        trustScore: { type: String, default: 'TRUST_V1' },
        repairCost: { type: String, default: 'REPAIR_V1' },
        marketValuation: { type: String, default: 'VALUATION_V1' },
      },
      executiveVerdict: {
        verdictCode: String,
        badgeVariant: String,
